            ...
            value: function init(option) {
                ...
                for (var i = 0; i < this.packages.length; i++) {
                    ...
                    for (var _i = 0; _i < opackage.length; _i++) {
                        let owoName = this.packages[i];
                        if (owoName != undefined) {
                            let owoType = this.odata[owoName].type;
                            if (owoType == "emoticon") {
                                html += `
                                <li class="OwO-item" title="${opackage[_i].text}" data-id="${opackage[_i].icon}">${opackage[_i].icon}</li>
                              `;
